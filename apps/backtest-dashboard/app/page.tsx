  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      >
        ...
        <div className="px-2 pb-2 border-t border-[var(--border)] pt-1">
          <Link
            href="/research"
          ...
          >
            <span className="shrink-0 text-emerald-400"><Crosshair size={18} /></span>
            {!collapsed && <span className="truncate font-medium text-emerald-300">Research Lab</span>}
          </Link>
        </div>
