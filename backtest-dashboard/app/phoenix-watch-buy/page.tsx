  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      <header className="border-b border-[var(--border)] bg-[var(--bg-card)] px-6 py-4">
        <Link
          href="/trading-runs"
          className="inline-flex items-center gap-2 text-sm text-[var(--text-dim)] hover:text-indigo-400 mb-3"
        >
          <ArrowLeft size={16} /> Trading runs
        </Link>
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[var(--text-dim)] mt-1 max-w-2xl">
              Toggle <strong className="text-[var(--text)]">All tickers</strong> to see{" "}
              <span className="text-emerald-400 font-medium">TP</span> / <span className="text-red-400 font-medium">FP</span> /{" "}
              <span className="text-cyan-400 font-medium">TN</span> / <span className="text-amber-400 font-medium">FN</span> for every symbol in the run (matches confusion matrix).{" "}
              <code className="text-cyan-400/90 text-xs">master_pilot.json</code>
            </p>
          </div>
